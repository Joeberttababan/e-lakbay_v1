    ...
    <section className="hero-section-bg relative flex items-center justify-center min-h-screen pt-24 md:pt-28">
      ...
      <div className="relative z-10 w-full max-w-5xl px-6 flex flex-col items-center">
        <div className="text-left w-full">
          <h1 className="text-white text-4xl md:text-8xl font-semibold ">Explore</h1>
          <h1 className="text-hero-gradient text-transparent text-4xl md:text-7xl font-semibold mt-2 drop-shadow-white drop-shadow-xl">
